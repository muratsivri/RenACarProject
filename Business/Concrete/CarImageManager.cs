...
namespace Business.Concrete
{
    ...
    //    {
    //        IResult result = BusinessRules.Run(CheckIfCarImageImageCountNull(carImageId));
    //        if (result != null)
    //        {
    ...
    //        }
    //        return new SuccessDataResult<List<CarImage>>(_carImageDal.GetAll(c => c.CarImageId == carId).ToList());
    //    }
    //}
}
